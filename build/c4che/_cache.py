...
CFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-fdebug-prefix-map=/tmp/build/80754af9/python_1564510748219/work=/usr/local/src/conda/python-3.6.9', '-fdebug-prefix-map=/home/zilong/anaconda3=/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-fdebug-prefix-map=/tmp/build/80754af9/python_1564510748219/work=/usr/local/src/conda/python-3.6.9', '-fdebug-prefix-map=/home/zilong/anaconda3=/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-fwrapv', '-O3']
...
EXAMPLE_DIRECTORIES = ['tcp', 'udp-client-server', 'naming', 'wireless', 'routing', 'matrix-topology', 'udp', 'stats', 'ipv6', 'tutorial', 'realtime', 'socket', 'energy', 'error-model', 'traffic-control']
...
INCLUDES_PYEMBED = ['/home/zilong/anaconda3/include/python3.6m']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_BOOST = ['/usr/lib/x86_64-linux-gnu']
LIBPATH_PYEMBED = ['/home/zilong/anaconda3/lib/python3.6/config-3.6m-x86_64-linux-gnu', '/home/zilong/anaconda3/lib']
LIBPATH_ST = '-L%s'
...
NS3_EXECUTABLE_PATH = ['/home/zilong/rdma/NS3-RDMA/build/src/fd-net-device', '/home/zilong/rdma/NS3-RDMA/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/6', '/home/zilong/rdma/NS3-RDMA/build/lib']
...
cfg_files = ['/home/zilong/rdma/NS3-RDMA/build/ns3/config-store-config.h', '/home/zilong/rdma/NS3-RDMA/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
